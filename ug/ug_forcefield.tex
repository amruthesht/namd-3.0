...
\item
\NAMDCONFWDEF{oneFourScaling}{scaling factor for 1-4 electrostatic interactions}
...
Replaces the deprecated \texttt{\icommand{1-4scaling}} keyword.}
...
\begin{align*} \label{groupResEnergy}
...
\item
\NAMDCONFWDEF{groupRestraints}{are group position restraints active?}{{\tt on} or {\tt off}}{{\tt off}}
{Specifies whether or not group position restraints are active.}

\item
\NAMDCONFTAG{group1File}{group 1 atom indices file name}{UNIX file name}
...
\item
\NAMDCONFTAG{group1List}{group 1 list of atom indices}{list of integer}
...
\item
\NAMDCONFTAG{group1RefPos}{group 1 reference COM position}{float triple (x y z)}
{Reference COM positions for group 1.
The COM of atoms specified in {\tt group2File} or {\tt group2List} 
will be restrained about this position.}

\item
\NAMDCONFTAG{group2File}{group 2 atom indices file name}{UNIX file name}
...
\item
\NAMDCONFTAG{group2List}{group 2 list of atom indices}{list of integer}
...
\item
\NAMDCONFTAGWDEF{groupResX}{Restrain X components of distance}{{\tt on} or {\tt off}}{{\tt on}}
...
\item
\NAMDCONFTAGWDEF{groupResY}{Restrain Y components of distance}{{\tt on} or {\tt off}}{{\tt on}}
{Restrain the Cartesian Y components of the distance 
$\mathbf{\overrightarrow{r}^{\text{COM}}_{2}} - \mathbf{\overrightarrow{r}^{\text{COM}}_{1}}$.}

\item
\NAMDCONFTAGWDEF{groupResZ}{Restrain Z components of distance}{{\tt on} or {\tt off}}{{\tt on}}
