...
public:
  ...
  int numMolecules;           ///< Number of molecules
  int numLargeMolecules;      ///< Number of large molecules (compare to LARGEMOLTH)
  int32 *moleculeStartIndex;  ///< starting index of each molecule
  int32 *moleculeAtom;        ///< atom index for all molecules
