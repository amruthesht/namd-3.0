...
//  ADD SPECIAL CODE TO send_SimParameters() and receive_SimParameters()
  ...
  Bool CUDASOAintegrateMode;
      /**< mode flag set by "CUDASOAintegrate on" in config file
       * this remains set the same, no matter whether our activity is
...
//fepe
  ...
  Bool usePMEGPU; /**< replacement keyword for usePMECUDA */
        ...
        int bondedGPU; /**< replacement keyword for bondedCUDA */
	...
	Bool useCUDANonbondedForceTable; /**< direct nonbonded kernel math for non-PME steps (experimental) */
	Bool useGPUNonbondedForceTable; /**< replacement for useCUDANonbondedForceTable */

    Bool useDeviceMigration; /**< atom migration on GPU (experimental) */
    Bool useGPUAtomMigration; /**< replacement for useDeviceMigration */
    Bool updateAtomMap; /**< Used for experimenting with atom maps*/
