...
*/
  // The migration countdown is getting crapped up for some reason.
  // The migrationCountdown should be zero everytime I need to do a migration step here
...
void PatchMgr::setHomePatchFixedAtomNum(int patchId, int numFixed){
