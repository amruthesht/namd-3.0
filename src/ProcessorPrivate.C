...
CkpvDeclare(ComputeGlobalResultsMsg*, ComputeGlobalResultsMsg_instance);
#endif
...
#if defined(NAMD_CUDA) || defined(NAMD_HIP)
  CkpvInitialize(SequencerCUDA*, SequencerCUDA_instance);
  CkpvAccess(SequencerCUDA_instance) = 0;
#endif
...
#ifdef NODEGROUP_FORCE_REGISTER
  CkpvInitialize(ComputeGlobalResultsMsg*, ComputeGlobalResultsMsg_instance);
  CkpvAccess(ComputeGlobalResultsMsg_instance) = nullptr;
#endif
